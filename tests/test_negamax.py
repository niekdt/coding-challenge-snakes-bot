...
def test_search_extension_issue(search, depth):
    ...
    assert best_move(moves) in (Move.LEFT, Move.UP)  # unclear which move is best, but RIGHT is not picked due to pruning
...
def test_trap8(search, depth):
    board = Board(16, 16)
    board.set_state(
        snake1=Snake(id=1, positions=np.array([[14, 11], [14, 12], [13, 12], [12, 12], [11, 12], [10, 12], [10, 13], [9, 13], [8, 13], [7, 13], [7, 12], [7, 11], [7, 10], [8, 10], [9, 10], [10, 10], [11, 10], [12, 10], [13, 10], [14, 10], [14, 9], [13, 9], [12, 9], [11, 9], [10, 9], [10, 8]])),
        snake2=Snake(id=0, positions=np.array([[1, 10], [1, 11], [1, 12], [1, 13], [1, 14], [2, 14], [3, 14], [4, 14], [5, 14], [6, 14], [6, 13], [6, 12], [6, 11], [6, 10], [6, 9], [6, 8], [6, 7], [6, 6], [6, 5]])),
...
def test_wall_search(search, depth):
    board = Board(16, 16)
    board.set_state(
        snake1=Snake(id=1, positions=np.array([[15, 11], [14, 11], [14, 12], [13, 12], [12, 12], [11, 12], [10, 12], [10, 13], [9, 13], [8, 13], [7, 13], [7, 12], [7, 11], [7, 10], [8, 10], [9, 10], [10, 10], [11, 10], [12, 10], [13, 10], [14, 10], [14, 9], [13, 9], [12, 9], [11, 9], [10, 9], [10, 8]])),
        snake2=Snake(id=0, positions=np.array([[1, 10], [1, 11], [1, 12], [1, 13], [1, 14], [2, 14], [3, 14], [4, 14], [5, 14], [6, 14], [6, 13], [6, 12], [6, 11], [6, 10], [6, 9], [6, 8], [6, 7], [6, 6], [6, 5]])),
        candies=[np.array([2, 9]), np.array([4, 10]), np.array([4, 9])]
    )
    moves = search(board, depth=depth, eval_fun=best.evaluate)
...
def test_follow_tail(search, depth):
    board = Board(16, 16)
    board.set_state(
        snake1=Snake(id=1, positions=np.array([[7, 5], [8, 5], [9, 5], [10, 5], [10, 6], [9, 6], [8, 6], [8, 7], [8, 8], [8, 9], [7, 9], [7, 8], [7, 7], [6, 7], [5, 7], [4, 7], [3, 7], [2, 7], [2, 8], [2, 9], [2, 10], [2, 11], [2, 12], [2, 13], [1, 13], [0, 13], [0, 14], [1, 14], [2, 14], [3, 14]])),
        snake2=Snake(id=0, positions=np.array([[9, 14], [10, 14], [10, 13], [9, 13], [8, 13], [8, 12], [8, 11], [9, 11], [9, 10], [9, 9], [9, 8], [10, 8], [10, 7], [11, 7], [11, 6], [12, 6], [12, 5], [11, 5], [11, 4], [10, 4], [10, 3], [10, 2], [10, 1], [9, 1], [9, 2], [8, 2], [7, 2], [6, 2], [6, 3], [7, 3], [8, 3], [8, 4], [7, 4], [6, 4], [5, 4], [4, 4], [4, 5], [4, 6], [5, 6], [5, 5], [6, 5], [6, 6]])),
        candies=[]
    )
